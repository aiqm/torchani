...
model = torchani.models.ANI2x(use_neurochem_source=True)
...
model = torchani.models.ANI1x(use_neurochem_source=True)
...
model = torchani.models.ANI1ccx(use_neurochem_source=True)
